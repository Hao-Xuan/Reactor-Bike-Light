...
The architecture was developed around a simple principle: separate each major responsibility into an independent subsystem with a clearly defined role. This approach simplified both development and debugging while allowing individual portions of the hardware and firmware to evolve independently as the design matured.
